...
ActiveRecord::Schema.define(version: 20_150_521_235_752) do
  ...
  add_index 'pages', %w(pageable_type pageable_id), name: 'index_pages_on_pageable_type_and_pageable_id', using: :btree
